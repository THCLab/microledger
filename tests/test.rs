...
//     let bp = ControllingIdentifier::Basic(BasicPrefix::Ed25519(pk));
...
//     let s = KeriSignature::SelfSigning(SelfSigningPrefix::Ed25519Sha512(signature_raw));
...
//     let nbp = ControllingIdentifier::Basic(BasicPrefix::Ed25519(npk));
...
//     let nnbp = ControllingIdentifier::Basic(BasicPrefix::Ed25519(nnpk));
