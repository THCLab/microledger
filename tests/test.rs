use keri::{derivation::self_signing::SelfSigning, keys::{PrivateKey, PublicKey}, prefix::SelfSigningPrefix};
use microledger::{Serialization, controling_identifiers::Rules,};
...
#[test]
fn test() {
	let mut microledger: MicroLedger<SelfAddressingPrefix, SelfAddressingPrefix, Rules, DummyProvider, SelfSigningPrefix> = MicroLedger::new();
